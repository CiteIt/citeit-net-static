...
function get_device_size(metric) {
    ...
    console.log("Heightxxx: " + window.innerHeight);
    ...
    metrics = {
        ...
        'window_height': window_height,   // 350
    }
